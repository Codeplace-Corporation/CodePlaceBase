...
function JobPostingForm({ closeForm }) {
  ...
  const [filePermissions, setFilePermissions] = useState('public');
  const [selectedJobPostType, setSelectedJobPostType] = useState(""); // State for selected job post type

  const totalSteps = 8; // Update totalSteps to 8
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://us-central1-codeplace-76019.cloudfunctions.net/createCheckoutSession', {
        ...
        body: JSON.stringify({
          jobId: 'job_12345', // Replace with actual job ID
  ...
  const handleAddTool = () => {
    if (toolInput.trim() !== '') {
      setTools([...tools, { name: toolInput.trim() }]);
      setToolInput('');
    }
  };
  ...
  const handleFilePermissionsChange = (e) => {
    setFilePermissions(e.target.value);
  };

  const handleJobPostTypeClick = (type) => {
    setSelectedJobPostType(type);
  };
        ...
        {step === 1 && (
          <div>
            ...
            <div className="job-posting-form__field">
              ...
              <input type="text" name="projectTitle" className="job-posting-form__input" />
            </div>
            <div className="job-posting-form__field">
              <label className="job-posting-form__label">Company Name</label>
              <input type="text" name="companyName" className="job-posting-form__input" />
            </div>
            <div className="job-posting-form__field">
              <label className="job-posting-form__label">Project Overview</label>
              <textarea name="projectOverview" className="job-posting-form__textarea"></textarea>
            </div>
            <div className="job-posting-form__field">
            ...
            <div className="job-posting-form__field">
              ...
              <div className="job-posting-form__icons">
                {jobPostTypes.map(({ type, icon }) => (
                  <div
                    key={type}
                    className={`job-posting-form__icon-container ${selectedJobPostType === type ? 'selected' : ''}`}
            ...
            {selectedJobPostType === 'Auction' && (
              <>
                <div className="job-posting-form__field">
                  ...
                  <input type="text" name="auctionStartingBid" className="job-posting-form__input" />
                </div>
                <div className="job-posting-form__field">
                  <label className="job-posting-form__label">Auction Start Time</label>
                  <input type="datetime-local" name="auctionStartTime" className="job-posting-form__input" />
                </div>
                <div className="job-posting-form__field">
                  <label className="job-posting-form__label">Auction Length</label>
                  <input type="text" name="auctionLength" className="job-posting-form__input" />
                </div>
              </>
            )}
            {selectedJobPostType === 'Bounty' && (
              <>
                <div className="job-posting-form__field">
                  ...
                  <input type="text" name="bountyAmount" className="job-posting-form__input" />
                </div>
                <div className="job-posting-form__field">
                  <label className="job-posting-form__label">Project Start</label>
                  <input type="datetime-local" name="projectStart" className="job-posting-form__input" />
                </div>
                <div className="job-posting-form__field">
                  <label className="job-posting-form__label">Project End</label>
                  <input type="datetime-local" name="projectEnd" className="job-posting-form__input" />
                </div>
              </>
            )}
            {selectedJobPostType === 'Contract' && (
              <>
                <div className="job-posting-form__field">
                  ...
                  <input type="text" name="contractAmount" className="job-posting-form__input" />
                </div>
                <div className="job-posting-form__field">
                  <label className="job-posting-form__label">Contract Apply Period Start</label>
                  <input type="datetime-local" name="contractApplyPeriodStart" className="job-posting-form__input" />
                </div>
                <div className="job-posting-form__field">
                  <label className="job-posting-form__label">Contract Apply Period End</label>
                  <input type="datetime-local" name="contractApplyPeriodEnd" className="job-posting-form__input" />
                </div>
              </>
            )}
            {selectedJobPostType === 'Challenge' && (
              <>
                <div className="job-posting-form__field">
                  ...
                  <input type="text" name="challengeAmount" className="job-posting-form__input" />
                </div>
                <div className="job-posting-form__field">
                  <label className="job-posting-form__label">Challenge Start Time</label>
                  <input type="datetime-local" name="challengeStartTime" className="job-posting-form__input" />
                </div>
              </>
            )}
            <div className="job-posting-form__field">
              <label className="job-posting-form__label">Project Start Time</label>
              <input type="datetime-local" name="projectStartTime" className="job-posting-form__input" />
            </div>
            <div className="job-posting-form__field">
              <label className="job-posting-form__label">Project End Time</label>
              <input type="datetime-local" name="projectEndTime" className="job-posting-form__input" />
            </div>
            <div className="job-posting-form__field">
              <label className="job-posting-form__label">Project Length</label>
              <input type="text" name="projectLength" className="job-posting-form__input" />
            </div>
            <div className="job-posting-form__field">
              <label className="job-posting-form__label">Included Revisions</label>
              <input type="number" name="includedRevisions" className="job-posting-form__input" />
            </div>
            <div className="job-posting-form__field">
              <label className="job-posting-form__label">Extra Paid Revisions</label>
              <input type="number" name="extraPaidRevisions" className="job-posting-form__input" />
            </div>
            <button type="button" className="job-posting-form__prev-button" onClick={prevStep}>
              Previous
            </button>
        ...
        {step === 4 && (
          <div>
            ...
            <div className="job-posting-form__field">
              ...
              <textarea name="requirements" className="job-posting-form__textarea"></textarea>
            </div>
            <div className="job-posting-form__field">
              <label className="job-posting-form__label">Project Milestones</label>
              <textarea name="milestones" className="job-posting-form__textarea"></textarea>
            </div>
            <div className="job-posting-form__field">
              <label className="job-posting-form__label">Amount of Prepaid Revisions</label>
              <input type="number" name="prepaidRevisions" className="job-posting-form__input" />
            </div>
            <div className="job-posting-form__field">
              <label className="job-posting-form__label">Cost of Revisions</label>
              <input type="text" name="revisionCost" className="job-posting-form__input" />
            </div>
            <div className="job-posting-form__field">
              <label className="job-posting-form__label">Late Discount</label>
              <input type="text" name="lateDiscount" className="job-posting-form__input" />
            </div>
            <button type="button" className="job-posting-form__prev-button" onClick={prevStep}>
              Previous
            </button>
              ...
              <div className="job-posting-form__permissions">
                <label>
                  <input 
                    ...
                    value="public" 
                    checked={filePermissions === 'public'} 
                ...
                <label>
                  <input 
                    ...
                    name="filePermissions" 
                    value="applicants" 
                    checked={filePermissions === 'applicants'} 
                    onChange={handleFilePermissionsChange} 
                  />
        ...
        {step === 6 && (
          <div>
            ...
            <div className="job-posting-form__field">
              ...
              <input type="datetime-local" name="postLiveDate" className="job-posting-form__input" />
            </div>
            <div className="job-posting-form__field">
              <label className="job-posting-form__label">Auction Length</label>
              <input type="text" name="auctionLength" className="job-posting-form__input" />
            ...
            <div className="job-posting-form__field">
              ...
              <input type="text" name="jobClosedTiming" className="job-posting-form__input" />
            </div>
            <button type="button" className="job-posting-form__prev-button" onClick={prevStep}>
              Previous
            </button>
