    ...
    <div className="space-y-6 max-w-4xl">
      ...
      <div>
        ...
        <textarea
          ...
          className={`w-full px-4 py-3 bg-white/5 border rounded-md text-white text-sm placeholder-white/50 focus:outline-none focus:ring-1 focus:ring-orange-400 resize-none min-h-[200px] ${
...
Be as specific as possible to help developers understand exactly what you need..."
      ...
      <div>
        <label className="block text-white font-medium mb-2 text-sm flex items-center gap-2">
          <FontAwesomeIcon icon={faCodeBranch} className="text-orange-400" />
        ...
        <div className="flex gap-2">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-3 py-2 bg-white/5 border border-white/20 rounded-md text-white text-sm placeholder-white/50 focus:outline-none focus:ring-1 focus:ring-orange-400"
            ...
            <>
              ...
              <div className="p-4 border-b border-white/10 flex justify-between items-center py-0">
                ...
                <label
                  ...
                  className="px-3 bg-orange-500/20 border border-orange-500/30 rounded text-orange-300 hover:bg-orange-500/30 transition-colors cursor-pointer text-xs font-medium flex items-center gap-1"
                >
              ...
              {dragActive && (
                <div className="absolute inset-2 border-2 border-dashed border-orange-400 rounded-lg bg-orange-400/10 flex items-center justify-center">
                  <div className="text-center">
                    <FontAwesomeIcon icon={faUpload} className="text-orange-400 text-3xl mb-2" />
                    <p className="text-orange-400 font-medium">Drop files here to add them</p>
                  </div>
                </div>
              )}
            </>
