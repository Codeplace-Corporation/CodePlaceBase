...
const AuctionJobDetails: React.FC<AuctionJobDetailsProps> = ({ job, onBack }) => {
  ...
  const handleSubmitProposal = (): void => {
    console.log("Submitting bid for auction:", job.id, {
      bidAmount,
      proposalText
    });
  ...
  const getBudgetRange = () => {
    ...
    return `$${formatCompensation(job.compensation)} (maximum)`;
  };
      ...
      <div className="max-w-6xl mx-auto px-6 pt-20 pb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="bg-[rgba(255,255,255,0.05)] p-4 rounded-lg">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-sm text-white/70">Auction Closes</span>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-3">
            ...
            <div className="bg-[rgba(255,255,255,0.05)] rounded-lg p-6 pt-0 border border-orange-500/30">
              ...
              <div className="grid grid-cols-1 gap-3 text-sm">
                {job.auctionStartTime && (
                  <div>
                    ...
                    <div className="font-semibold">{formatDate(job.auctionStartTime)}</div>
                  </div>
                )}
                {job.auctionEndTime && (
                  <div>
                    <span className="text-white/50">Auction End:</span>
                    <div className="font-semibold">{formatDate(job.auctionEndTime)}</div>
                  </div>
                )}
                <div>
                ...
                <div>
                  ...
                  <div className="font-semibold text-orange-300">{job.projectDeadline || "To be determined"}</div>
                </div>
                {job.revisionCost && (
                  <div>
            ...
            <div className="bg-[rgba(255,255,255,0.05)] rounded-lg p-6 pt-2">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex justify-between">
                  <span className="text-white/50">Auctions Posted:</span>
                  <span>23</span>
                </div>
                <div className="flex justify-between">
